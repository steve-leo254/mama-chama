...
export default function WalletOverview() {
  ...
  const totalOut: number = transactions
    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm shadow-black/5 p-6">
          ...
          <p className="text-2xl font-bold text-gray-900">KES {stats.totalContributions.toLocaleString()}</p>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm shadow-black/5 p-6">
          ...
          <p className="text-2xl font-bold text-gray-900">KES {stats.totalLoansAmount.toLocaleString()}</p>
          <p className="text-sm text-gray-500 mt-2">{stats.totalLoansActive} active loans</p>
        </div>
